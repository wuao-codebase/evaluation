    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("学分下限", evaluat.getBYXFZS(), 200));
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 40));
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 18));
                evals.append(evalService.compmin("生均图书", evaluat.getZYTUSHU(), 80));
                evals.append(evalService.compmin("仪器设备总值(万元)", evaluat.getZSBF(), 1500));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\动物医学.txt");
            writer.write( "————动物医学————\r\n");
