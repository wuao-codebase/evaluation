...
public class ZhengZhixue {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("30201","30202","30203","030204T","030205T");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.compmin("学分下限", evaluat.getBYXFZS(), 120));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\政治学.txt");
            writer.write( "————政治学————\r\n");
