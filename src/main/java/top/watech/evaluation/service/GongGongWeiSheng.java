...
public class GongGongWeiSheng {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            FileWriter writer = new FileWriter(args[0]+"\\公共卫生与预防医学.txt");
            writer.write( "————公共卫生与预防医学————\r\n");
