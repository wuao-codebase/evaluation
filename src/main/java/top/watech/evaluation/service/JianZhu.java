...
public class JianZhu {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("82801","82802","82803","082804T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmax("学分上限", evaluat.getBYXFZS(), 220));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\建筑.txt");
            writer.write( "————建筑————\r\n");
