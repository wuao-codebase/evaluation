...
public class ZhongGuoYuYan {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("50101","50102","50103","50104","50105");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmax("学分上限", evaluat.getBYXFZS(), 140));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\中国语言文学.txt");
            writer.write( "————中国语言文学————\r\n");
