...
public class GongAnJiShu {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("083101K","083102K","083103TK","083104TK","083105TK","083106TK","083107TK","083108TK","083109TK","083110TK");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.compmin("学分下限", evaluat.getBYXFZS(), 170));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\公安技术.txt");
            writer.write( "————公安技术————\r\n");
