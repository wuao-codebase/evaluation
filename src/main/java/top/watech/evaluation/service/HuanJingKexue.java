...
public class HuanJingKexue {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("82501","82502","82503","082505T","082506T","082507T");
            ...
            FileWriter writer = new FileWriter(args[0]+"\\环境科学与工程.txt");
            writer.write( "————环境科学与工程————\r\n");
