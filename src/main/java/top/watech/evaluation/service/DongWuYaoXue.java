...
public class DongWuYaoXue {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("90402");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 12));
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 18));
                evals.append(evalService.compthreemin("副教授以上", evaluat.getZGJSZS(), evaluat.getFGJSZS(), evaluat.getJSZS(), 0.6));
                ...
                evals.append(evalService.comptowmin("生均专业教学科研仪器设备(万元)",evaluat.getZSBF() ,evaluat.getZXSRS(), 0.3));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\动物药学.txt");
            writer.write( "————动物药学————\r\n");
