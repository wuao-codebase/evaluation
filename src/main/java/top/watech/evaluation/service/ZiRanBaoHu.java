...
public class ZiRanBaoHu {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("90201","90202","90203");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 14));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\自然保护与环境生态.txt");
            writer.write( "————自然保护与环境生态————\r\n");
