...
public class DianYingYuDianShi {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("130301","130303","130304","130306","130307","130308","130311T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.comptowmin("生均专业教学科研仪器设备(万元)",evaluat.getZSBF() ,evaluat.getZXSRS(), 0.1));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\电影与电视.txt");
            writer.write( "————电影与电视————\r\n");
