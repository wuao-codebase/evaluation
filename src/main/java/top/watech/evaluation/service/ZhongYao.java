...
public class ZhongYao {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("100801","100802","100805T","100806T");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 35));
                evals.append(evalService.compmin("仪器设备总值(万元)", evaluat.getZSBF(), 400));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\中药学.txt");
            writer.write( "————中药学————\r\n");
