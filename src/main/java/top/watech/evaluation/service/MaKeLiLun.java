...
public class MaKeLiLun {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("30501","30502","30503");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 8));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\马克思主义理论.txt");
            writer.write( "————马克思主义理论————\r\n");
