...
public class DongWuShengChan {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("90301","090302T","090303T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 25));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\动物生产.txt");
            writer.write( "————动物生产————\r\n");
