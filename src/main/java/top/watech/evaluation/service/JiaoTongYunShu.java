...
public class JiaoTongYunShu {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("81801","81802","081803K","081804K","081805K","081806T","081807T","081808TK");
            ...
            FileWriter writer = new FileWriter(args[0]+"\\交通运输.txt");
            writer.write( "————交通运输————\r\n");
