...
public class CaiLiao {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("80401","80402","80403","80404","80405","80406","80407",
                    "80408","080409T","080410T","080411T","080412T","080413T","080414T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmax("学分上限", evaluat.getBYXFZS(), 190));
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 18));
                evals.append(evalService.compthreemin("副教授以上", evaluat.getZGJSZS(), evaluat.getFGJSZS(), evaluat.getJSZS(), 0.5));
                evals.append(evalService.comptowmin("生均年教学运行支出(万元)",evaluat.getDNJXJF() ,evaluat.getZXSRS(), 0.12));
                evals.append(evalService.comptowmin("生均专业教学科研仪器设备(万元)",evaluat.getZSBF() ,evaluat.getZXSRS(), 1.5));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\材料.txt");
            writer.write( "————材料————\r\n");
