...
public class HangKongHangTian {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("82001","82002","82003","82004","82005","082006T","082007T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 12));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\航空航天.txt");
            writer.write( "————航空航天————\r\n");
