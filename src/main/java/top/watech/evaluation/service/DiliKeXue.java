...
public class DiliKeXue {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("70501","70502","70503","70504");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.comptowmin("生均年教学运行支出(万元)",evaluat.getDNJXJF() ,evaluat.getZXSRS(), 0.25));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\地理科学.txt");
            writer.write( "————地理科学————\r\n");
