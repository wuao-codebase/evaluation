...
public class DiQiuWuLi {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("70801","70802");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 7));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\地球物理学.txt");
            writer.write( "————地球物理学————\r\n");
