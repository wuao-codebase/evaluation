...
public class GongGongGuanLi {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("120401","120402","120403","120404","120405","120406TK","120407T","120408T","120409T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.comptowmin("生均年教学运行支出(万元)",evaluat.getDNJXJF() ,evaluat.getZXSRS(), 0.2));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\公共管理.txt");
            writer.write( "————公共管理————\r\n");
