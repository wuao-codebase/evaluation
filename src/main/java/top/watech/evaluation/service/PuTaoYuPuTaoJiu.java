...
public class PuTaoYuPuTaoJiu {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("082706T");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 5));
                ...
                evals.append(evalService.compmin("生均图书", evaluat.getZYTUSHU(), 10));
                ...
                evals.append(evalService.comptowmin("生均专业教学科研仪器设备(万元)",evaluat.getZSBF() ,evaluat.getZXSRS(), 0.2));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\葡萄与葡萄酒工程.txt");
            writer.write( "————葡萄与葡萄酒工程————\r\n");
