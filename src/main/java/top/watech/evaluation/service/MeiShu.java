...
public class MeiShu {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("130401","130402","130403","130404","130405T","130406T","130407T","130408TK");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.comptowmax("生师比", evaluat.getZXSRS(), evaluat.getJSZS(), 13));
                evals.append(evalService.compthreemin("副教授以上", evaluat.getZGJSZS(), evaluat.getFGJSZS(), evaluat.getJSZS(), 0.25));
                if ((evals).length()>0) {
            ...
            FileWriter writer = new FileWriter(args[0]+"\\美术类.txt");
            writer.write( "————美术类————\r\n");
