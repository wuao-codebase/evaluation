...
public class LinChuangYaoXue {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("100703TK");
            List<Evaluat> eval = evalMapper.getEval(list);
            for (Evaluat evaluat : eval) {
                StringBuilder evals = new StringBuilder();
                evals.append(evalService.compmin("学分下限", evaluat.getBYXFZS(), 180));
                evals.append(evalService.compmax("学分上限", evaluat.getBYXFZS(), 200));
                evals.append(evalService.compmin("师资人数", evaluat.getJSZS(), 20));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\临床药学.txt");
            writer.write( "————临床药学————\r\n");
