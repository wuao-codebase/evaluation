...
public class YingYongQiXiang {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> list = Arrays.asList("70602");
            ...
            for (Evaluat evaluat : eval) {
                ...
                evals.append(evalService.compmin("生均图书", evaluat.getZYTUSHU(), 30));
            ...
            FileWriter writer = new FileWriter(args[0]+"\\应用气象.txt");
            writer.write( "————应用气象————\r\n");
