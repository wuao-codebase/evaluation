...
public class ShengWuXinXi {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            FileWriter writer = new FileWriter(args[0]+"\\生物信息.txt");
            writer.write( "————生物信息————\r\n");
